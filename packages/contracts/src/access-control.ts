...
export const permissionDefinitions: PermissionDefinition[] = [
  ...
  { key: "activity:read", group: "collaboration", resource: "activity", label: "View global activity", description: "View activity tied to modules the role can access.", dependencies: [] },
